...
Player::Player()
{
    ...
    walkingRightFrames.push_back(new Sprite("img/player/playerRight1.png"));
    walkingRightFrames.push_back(new Sprite("img/player/playerRight2.png"));
    walkingRightFrames.push_back(new Sprite("img/player/playerRight3.png"));

    walkingLeftFrames.push_back(new Sprite("img/player/playerLeft1.png"));
    walkingLeftFrames.push_back(new Sprite("img/player/playerLeft2.png"));
    walkingLeftFrames.push_back(new Sprite("img/player/playerLeft3.png"));
...
Player::~Player()
{
    for (Sprite* sprite : walkingRightFrames)
    {
        delete sprite;
    }

    for (Sprite* sprite : walkingLeftFrames)
    {
        delete sprite;
    }
}

void Player::update(std::vector<Chunk*>& chunks)
{
    handleStates();
...
void Player::animatePlayer(std::vector<Sprite*>& frames)
{
...
void Player::handleCollisions(std::vector<Chunk*>& chunks)
{
